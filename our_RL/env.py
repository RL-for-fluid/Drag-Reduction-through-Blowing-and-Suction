...
def resume_env(plot=False,
    ...
    #====================== original below ==========================#
    # for 5 probes
    #list_position_probes.append(np.array([0.0  , -0.07]))
    #list_position_probes.append(np.array([0.0  , +0.07]))
    #list_position_probes.append(np.array([0.075, -0.1 ]))
    #list_position_probes.append(np.array([0.075,  0.0 ]))
    #list_position_probes.append(np.array([0.075, +0.1 ]))
    
    # for 11 probes
    list_position_probes.append(np.array([0.0  , -0.07]))
    list_position_probes.append(np.array([0.0  , +0.07]))
    list_position_probes.append(np.array([0.075, -0.15]))
    list_position_probes.append(np.array([0.075,  0.0 ]))
    list_position_probes.append(np.array([0.075, +0.15]))
    list_position_probes.append(np.array([0.2  , -0.15]))
    list_position_probes.append(np.array([0.2  ,  0.0 ]))
    list_position_probes.append(np.array([0.2  , +0.15]))
    list_position_probes.append(np.array([0.35 , -0.15]))
    list_position_probes.append(np.array([0.35 ,  0.0 ]))
    list_position_probes.append(np.array([0.35 , +0.15]))
